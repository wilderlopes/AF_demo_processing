...
void draw() {
  ...
  h.drawHeatMap(Distance.euclidean(data),0f,7f);
  // notice the top left block of somewhat similar bears?
  // also, bears 47 and 52 are dissimilar from almost all the other bears but themselves 
  // and each other! (white-ish lines). 
  // Upon inspection of the raw data, you'll see that both have ages greater than 100.
  ...
  */
  ...
  text("Darker colors indicate closer distances showing bears which are more 'similar'.\n"+
       "(Try sorting the csv file by something other than weight to see if you can find other patterns.)", xLeft,yTop-30);
}
